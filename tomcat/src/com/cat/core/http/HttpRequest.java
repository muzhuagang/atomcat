...
import com.cat.core.util.Enumerator;
import com.cat.core.util.ParameterMap;
...
/**
 * http请求对象，其中里面以parse开头的方法都是讲获取到的http相关信息初始化到HttpRequest中去
...
public class HttpRequest implements HttpServletRequest {
  ...
  public void addHeader(String name, String value) { //设置http头信息
   ...
   */
  protected void parseParameters() { //获取参数信息
    if (parsed)
      return;
  ...
  public void addCookie(Cookie cookie) { //设置cookie
