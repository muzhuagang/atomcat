...
//import com.cat.core.util.StringManager;
...
public class SocketInputStream extends InputStream {
     ...
     */
    public static final String Package = "com.cat.core";
...
//        StringManager.getManager(Package);
     ...
     * the whole line.
     */
    public void readRequestLine(HttpRequestLine requestLine) //返回一个HTTP请求的第一行
        throws IOException {

        // Recycling check
        if (requestLine.methodEnd != 0)  
            requestLine.recycle();       //重新初始化
     ...
     * the whole line.
     */
    public void readHeader(HttpHeader header)              //获取http头信息
        throws IOException {
